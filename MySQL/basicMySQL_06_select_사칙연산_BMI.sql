...
select attack*2 as attack2, attack ,name
from mypokemon;
...
인지하기 어렵기 때문에, 따옴표(‘’, “”)로 감싸 주어 의미를 분명하게 합니다. ※ FLOAT 데이터 타입은 입력 값의 근사치를 저장하기 때문에, 소수점이 나오는 게 정상입니다.
*/
...
from mypokemon
LIMIT 2;  -- limit는 2개만 가져오기 때문에 입력
